...
# Orienta NoAntagLabel
humanoid-profile-editor-noantag-label = На Ориенте вы сами решаете, кем стать. Возможно, вы возглавите тайное правительство, 
    манипулируя другими, станете культистом или просто превратитесь в беспощадного клептомана, поглощенного своим желанием. 
    Здесь вы можете быть кем угодно — антагонистом, психопатом или просто тем, кто следует собственным правилам, без страха и сомнений. 
    Всё зависит от того, что скрывает ваш разум...
    
    Подробнее про отыгрыш антагониста вы найдёте здесь: https://wiki.orientacorp.ru/Твой_Антагонист