...
ent-CrateSecuritySupplies = ящик припасов KDS
    .desc = Содержит различные припасы для KDS станции. Чтобы открыть необходим уровень доступа Служба безопасности.
...
ent-CrateSecurityBiosuit = ящик биозащитных костюмов KDS
