...
ent-StatueHeadOfSecurityDecoration = статуя главы KDS
    .desc = Статуя, посвященная самому умному главе KDS.
...
ent-StatueSecurityDecoration = статуя офицера KDS
    .desc = Статуя, посвященная самому умному офицеру KDS.
