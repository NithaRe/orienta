...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч - один из самых популярных продуктов компании Orienta. 'Почему мы делаем пляжные мячи? Потому что мы можем! (TM)' - Orienta.
...
ent-BalloonNT = воздушный шарик Orienta
