...
ent-SecurityCadetPDA = КПК кадета KDS
...
ent-PsychiatristPDA = КПК врача
    .desc = Блестящий и стерильный
ent-MedBrotherPDA = КПК врача
    .desc = Блестящий и стерильный
...
ent-SeniorOfficerPDA = КПК инструктора KDS
