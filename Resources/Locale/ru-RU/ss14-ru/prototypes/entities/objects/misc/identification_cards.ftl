...
ent-RDIDCard = ID карта научного руководителя
    .desc = { ent-IDCardStandard.desc }
ent-HoSIDCard = ID карта главы KDS
    .desc = { ent-IDCardStandard.desc }
...
ent-SeniorOfficerIDCard = ID карта инструктора KDS
