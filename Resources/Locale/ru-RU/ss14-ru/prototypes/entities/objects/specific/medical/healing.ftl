...
ent-Bloodpack = пакет крови
    .desc = Содержит новый инновационный универсальный кровезаменитель, разработанный передовыми учёными компании Orienta.
    .suffix = Полный
ent-Bloodpack10Lingering = { ent-Bloodpack }
    .suffix = 10, Не исчезают закончившись
    .desc = { ent-Bloodpack.desc }
ent-Tourniquet = тyрникет
...
ent-PillLidicaine = таблетка
    .desc = { ent-Pill.desc }
    .suffix = Лидикаин 10 ед
ent-PillAtractine = таблетка
    .desc = { ent-Pill.desc }
    .suffix = Атрактин 10 ед
ent-PillAnodium = таблетка
    .desc = { ent-Pill.desc }
    .suffix = Анодиум 10 ед
ent-PillCorvol = таблетка
    .desc = { ent-Pill.desc }
    .suffix = Корвол 10 ед
