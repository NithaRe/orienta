...
ent-VendingMachineRestockDiscountDans = набор пополнения Дискаунт Дэн
    .desc = Коробка, набитая солью и крахмалом. Зачем терпеть качество, когда есть количество? Дискаунт Дэн!
ent-VendingMachineRestockDonut = набор пополнения Пончики Робаст
...
ent-VendingMachineRestockGetmoreChocolateCorp = набор пополнения Гетмор Шоколда
...
ent-VendingMachineRestockSecTech = набор пополнения KDSТех
    .desc = Коммунисты берегитесь: подкрепление прибыло! На этикетке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ KDS".
...
ent-VendingMachineRestockSmokes = набор пополнения ШейдиСигс
