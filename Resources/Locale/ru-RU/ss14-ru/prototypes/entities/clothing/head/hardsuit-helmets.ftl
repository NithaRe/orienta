...
ent-ClothingHeadHelmetHardsuitSecurity = шлем скафандра KDS
    .desc = Бронированный шлем скафандра для нужд KDS.
ent-ClothingHeadHelmetHardsuitSecurityRed = шлем скафандра главы KDS
    .desc = Шлем скафандра KDS с новейшим сверхсекретным программным обеспечением NT-HUD. Принадлежит главе KDS.
