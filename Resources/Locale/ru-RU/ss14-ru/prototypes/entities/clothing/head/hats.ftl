...
ent-ClothingHeadHatBeretSecurity = берет охраны
    .desc = Стильный вариант одежды для сотрудников KDS.
...
ent-ClothingHeadHatBeretHoS = берет главы KDS
...
ent-ClothingHeadHatHoshat = шляпа главы KDS
    .desc = Верная фуражка стандартного образца начальника KDS. Чтобы показать офицерам, кто здесь командует.
