...
ent-ClothingOuterArmorWarden = { ent-AllowSuitStorageClothing }
    .desc = { ent-AllowSuitStorageClothing.desc }
ent-ClothingOuterCoatHoSTrench = тренч главы KDS
    .desc = Накидка символизирующая власть...
...
ent-ClothingOuterCoatPirate = одежда пирата
    .desc = Друзья мои! На носу корабля враг! Йахарр!
...
ent-ClothingOuterCoatAMG = Укрепленная медицинская куртка
    .desc = Куртка санитара укрепленная бронежилетом от корпорации "ORIENTA".
