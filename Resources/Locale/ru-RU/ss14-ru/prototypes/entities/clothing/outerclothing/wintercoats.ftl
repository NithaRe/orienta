...
ent-ClothingOuterWinterHoP = зимняя куртка главы персонала
    .desc = { ent-ClothingOuterWinterCoat.desc }
ent-ClothingOuterWinterHoS = зимняя бронекуртка главы KDS
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты главы KDS от любых угроз, связанных с бригом и переохлаждением.
ent-ClothingOuterWinterHoSUnarmored = зимняя куртка главы KDS
...
ent-ClothingOuterWinterSci = зимняя куртка учёного
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterSec = зимняя куртка KDS
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
