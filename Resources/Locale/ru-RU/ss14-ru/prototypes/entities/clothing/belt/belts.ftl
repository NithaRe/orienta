...
ent-ClothingBeltSecurity = пояс охраны
    .desc = Может вмещать различное снаряжение KDS, такое как наручники и вспышки.
...
ent-ClothingBeltSecurityWebbing = РПС охраны
    .desc = Уникальный, универсальный разгрузочный жилет с ремнями и поясом, может вмещать снаряжение KDS.
