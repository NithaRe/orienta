...
ent-ClothingNeckLawyerbadge = значок адвоката
    .desc = Значок, свидетельствующий что владелец является "законным" юристом, сдавшим экзамен Orienta, необходимый для занятия юридической практикой.
ent-ActionStethoscope = Прослушать стетоскопом
    .desc = { "" }
ent-Dinkystar = наклейка-звёздочка
    .desc = Маленькая звёздочка только для самых трудолюбивых сотрудников KDS! Она уже даже не липкая.
