...
ent-ClothingNeckMantleHOS = мантия главы KDS
    .desc = Перестрелки с оперативниками - это просто очередной вторник для этого GK. Эта мантия - символ преданности станции.
