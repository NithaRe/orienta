...
ent-ClothingNeckCloakHos = Плащ "KOVAK"
    .desc = Выдается только очень ответственным людям в корпорации "ORIENTA".
...
ent-ClothingNeckCloakOrienta = плащ Orienta
    .desc = Величественный синий плащ, представляющий Orienta.
...
ent-ClothingNeckCloakAce = pilot's cloak
    .desc = Cloak awarded to Orienta's finest space aces.
...
ent-ClothingNeckCloakGay = multi-level marketing cloak
    .desc = This cloak is highly sought after in the Orienta Marketing Offices.
