...
ent-PosterContrabandFunPolice = Шуты в KDS
    .desc = Плакат с критикой KDS станции.
...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как Orienta сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов Orienta. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном Orienta на космической станции, полной барсуков.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами Orienta.
...
ent-PosterContrabandRebelsUnite = Бунтари вместе
    .desc = Плакат, призывающий читателя восстать против Orienta.
...
ent-PosterLegitNanotrasenLogo = Логотип Orienta
    .desc = Плакат с изображением логотипа Orienta.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвященного 50-летию компании Nanoposters Manufacturing, дочерней компании Orienta.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков Orienta.
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти Orienta сегодня!
...
ent-PosterLegitNoERP = Скажи "НЕТ" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография запрещены на станциях "Orienta".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = Orienta распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
...
ent-PosterLegitSecWatch = KDS видит
...
ent-PosterLegitVacation = Корпоративные привилегии Orienta: Отпуск
    .desc = На этом информационном плакате представлена информация о некоторых призах, которые можно получить в рамках программы 'Корпоративные привилегии ORNT', включая двухнедельный отпуск на двоих на планете-курорте Идиллус.
...
ent-PosterLegitRenault = Постер с Алисой
    .desc = Йап.
ent-PosterLegitNTTGC = Тактическая карточная игра Orienta
    .desc = Реклама новой ТКИ от Orienta: ПОКУПАЙТЕ БОЛЬШЕ КАРТОЧЕК.
