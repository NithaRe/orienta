...
ent-BannerNanotrasen = знамя Orienta
    .desc = Это знамя с логотипом Orienta. Оно выглядит довольно дешево.
...
ent-BannerSyndicate = знамя Синдиката
    .desc = Знамя, из-за которого по мнению синдиката, вы должны возненавидеть ORNT.
