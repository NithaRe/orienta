...
ent-LockerParamedic = шкаф парамедика
    .desc = { ent-LockerBase.desc }
ent-LockerPsychiatrist = шкаф психиатра
    .desc = { ent-LockerBase.desc }
ent-LockerMedBrother = шкаф медбрата
    .desc = { ent-LockerBase.desc }
...
ent-LockerScientist = шкаф учёного
    .desc = { ent-LockerBase.desc }
ent-LockerHeadOfSecurity = шкаф главы KDS
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerWarden = шкаф смотрителя
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerBrigmedic = шкаф бригмедика
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerSecurity = шкаф офицера KDS
    .desc = { ent-LockerBaseSecure.desc }
...
ent-LockerMime = шкаф мима
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerRepresentative = шкаф представителя Orienta
    .desc = { ent-LockerBaseSecure.desc }
