...
ent-RandomHumanoidVisitorHOP = посетитель ГП роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorHOS = посетитель GK роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorRD = посетитель НР роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorQM = посетитель КМ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityCadet = посетитель кадет KDS роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityOfficer = посетитель офицер KDS роль призрака
    .desc = { "" }
...
ent-RandomHumanoidChallengeVictimHOP = жертва катастрофы ГП роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
ent-RandomHumanoidChallengeVictimHOS = жертва катастрофы GK роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
