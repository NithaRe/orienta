...
job-name-security = офицер KDS
job-name-cadet = кадет KDS
job-name-hos = глава KDS
...
JobHeadOfSecurity = глава KDS
JobJanitor = уборщик
JobLawyer = адвокат
JobLibrarian = библиотекарь
JobMedBrother = медбрат
...
JobPsychiatrist = психиатр
JobPsychotherapist = психотерапевт
...
JobScientist = учёный
JobSecurityCadet = кадет KDS
JobSecurityOfficer = офицер KDS
