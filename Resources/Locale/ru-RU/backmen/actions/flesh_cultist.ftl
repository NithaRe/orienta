...
ent-FleshCultistCreateFleshHeart = Создать сердце плоти
    .desc = Создает перед вами сердце плоти. Это ваша ключевая цель на станции. Чтобы активировать его, вам нужно использовать 3 тела эволюционировавших существ из плоти. После активации будьте готовы защищать его от сотрудников KDS.
