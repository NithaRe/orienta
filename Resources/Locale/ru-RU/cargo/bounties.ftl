...
bounty-description-banana = Привет, станция! Ботаники не хотят мне больше ничего давать. Они сказали, что поскользнуть и выкинуть GK в космос через открытый шлюз - это не смешно! Представляете? Помогите мне! ХОНК.
...
bounty-description-flashes = ПРИВЕТСТВИЕ \[Станция] НАМ НЕОБХОДИМЫ 6 ВСПЫШЕК ДЛЯ ОБЫЧНЫХ \[ТренировкаУпражнение] С СОТРУДНИКАМИ KDS. ВСЁ \[Нормально].
