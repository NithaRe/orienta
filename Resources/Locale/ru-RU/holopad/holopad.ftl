...
holopad-command-hos = Командование - GK
# Science
...
# S ecurity
holopad-security-front = KDS - Приёмная
holopad-security-brig = KDS - Бриг
holopad-security-warden = KDS - Смотритель
holopad-security-interrogation = KDS - Допросная
holopad-security-breakroom = KDS - Комната отдыха
holopad-security-detective = KDS - Детектив
holopad-security-perma = KDS - Перма
holopad-security-courtroom = KDS - Зал суда
holopad-security-lawyer = KDS - АВД
holopad-security-armory = KDS - Оружейная
holopad-security-locker-room = KDS - Раздевалка
holopad-security-brig-med = KDS - Бригмед
holopad-security-evac-checkpoint = KDS - КПП Эвакуация
holopad-security-arrivals-checkpoint = KDS - КПП Прибытие
# Service
